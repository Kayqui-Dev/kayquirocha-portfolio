...
interface BackgroundContoursProps {
  light?: boolean;
}

export default function BackgroundContours({ light = false }: BackgroundContoursProps) {
  const baseStroke = light ? "rgba(0, 0, 0, 0.04)" : "rgba(255, 255, 255, 0.035)";
  const accentStroke = light ? "rgba(0, 163, 255, 0.08)" : "rgba(0, 163, 255, 0.02)";
  const baseStrokeDark = light ? "rgba(0, 0, 0, 0.03)" : "rgba(255, 255, 255, 0.03)";
  const baseStrokeLight = light ? "rgba(0, 0, 0, 0.05)" : "rgba(255, 255, 255, 0.04)";
  const baseStrokeMedium = light ? "rgba(0, 0, 0, 0.035)" : "rgba(255, 255, 255, 0.025)";
  const accentStrokeLight = light ? "rgba(0, 163, 255, 0.06)" : "rgba(0, 163, 255, 0.015)";
