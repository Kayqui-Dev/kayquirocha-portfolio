export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center px-6 max-w-5xl mx-auto overflow-hidden pt-36 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6 animate-fade-in">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-white/[0.06] bg-white/[0.02] w-fit">
          ...
          {/* Title */}
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-extrabold tracking-tighter text-white leading-[1.02] sm:leading-[1.05]">
            Kayqui Rocha <br />
          ...
          {/* Bento Grid Style Metrics */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
            <div className="p-5 rounded-xl bg-zinc-900/40 border border-white/5 backdrop-blur-md hover:border-white/10 hover:bg-zinc-900/60 transition-all duration-300">
              <p className="text-2xl sm:text-3xl font-extrabold font-mono text-white tracking-tighter">7+ Anos</p>
              <p className="text-[9px] font-mono uppercase tracking-widest text-zinc-500 mt-1.5">Na Tecnologia</p>
            </div>
            <div className="p-5 rounded-xl bg-zinc-900/40 border border-white/5 backdrop-blur-md hover:border-white/10 hover:bg-zinc-900/60 transition-all duration-300">
              <p className="text-2xl sm:text-3xl font-extrabold font-mono text-white tracking-tighter">Full-Stack</p>
              <p className="text-[9px] font-mono uppercase tracking-widest text-zinc-500 mt-1.5">Foco Técnico</p>
            </div>
            <div className="p-5 rounded-xl bg-zinc-900/40 border border-white/5 backdrop-blur-md hover:border-white/10 hover:bg-zinc-900/60 transition-all duration-300">
              <p className="text-2xl sm:text-3xl font-extrabold font-mono text-white tracking-tighter">NTG</p>
              <p className="text-[9px] font-mono uppercase tracking-widest text-zinc-500 mt-1.5">Wrestling Elite</p>
            </div>
            <div className="p-5 rounded-xl bg-zinc-900/40 border border-white/5 backdrop-blur-md hover:border-white/10 hover:bg-zinc-900/60 transition-all duration-300">
              <p className="text-2xl sm:text-3xl font-extrabold font-mono text-white tracking-tighter">FMU / IA</p>
              <p className="text-[9px] font-mono uppercase tracking-widest text-zinc-500 mt-1.5">Formação</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mt-8 w-full sm:w-fit">
            <a
              href="#projetos"
              className="inline-flex h-11 items-center justify-center rounded-sm bg-white px-6 text-xs font-mono font-bold text-black uppercase hover:opacity-90 transition-opacity duration-300 w-full sm:w-auto text-center"
            >
              Ver Projetos
            </a>
            <a
              href="#contato"
              className="inline-flex h-11 items-center justify-center rounded-sm border border-white/[0.08] bg-transparent px-6 text-xs font-mono text-white uppercase hover:bg-white/[0.04] hover:border-white/20 transition-all duration-300 w-full sm:w-auto text-center"
            >
              Entrar em Contato
            </a>
          </div>
