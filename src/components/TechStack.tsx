...
const STACK_ITEMS = [
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-zinc-400 group-hover:text-accent-lime transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function TechStack() {
  ...
  return (
    <section id="stack" className="py-32 md:py-48 border-t border-white/[0.05] bg-black">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {STACK_ITEMS.map((tech, idx) => (
            <motion.div
              ...
              className="p-5 rounded-sm bg-zinc-950/60 border border-white/5 hover:border-accent-lime/30 transition-all duration-300 flex flex-col justify-between group select-none"
            >
              <div>
                {/* Header info */}
                ...
                {/* Name */}
                <h3 className="text-sm font-bold text-white tracking-tight mb-2 font-mono group-hover:text-accent-lime transition-colors duration-300">
                  {tech.name}
                </h3>
